...
#regression info
fname_stan_model = '../stan_lib/jian_fun_glob_reg_upd7.5GPdBr_log_res.stan'
#iteration samples
n_iter_warmup   = 5000
...
#output directory
dir_out = '../../Data/global_reg/bayesian_fit/JianFunUpd7.5GPdBr_log_res/' + fname_out_main + '/'
...
# - - - - - - - - - - - 
#hyper-parameters
col_names_hyp = ['r1','r2','r3','r4','s2','s3','s4','sigma_vel','ell_rdB','omega_rdB']
...
for k, v_id_dsid in enumerate(vel_id_dsid):
    ...
    param_n   =         1.0    + s2_new * sigmoid((np.log(vs30)-s3_new)*s4_new)
    param_a   =-1/param_n
