...
#regression info
fname_stan_model = '../stan_lib/jian_fun_glob_reg_upd7.3GPdBr_log_res.stan'
#iteration samples
n_iter_warmup   = 5000
...
#output directory
dir_out = '../../Data/global_reg/bayesian_fit/JianFunUpd7.3GPdBr_log_res/' + fname_out_main + '/'
...
# - - - - - - - - - - - 
#hyper-parameters
col_names_hyp = ['logVs30mid','logVs30scl','r1','r2','s2','delta_r1','delta_r2','sigma_vel','ell_rdB','omega_rdB']
