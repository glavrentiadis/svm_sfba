...
#regression info
fname_stan_model = '../stan_lib/jian_fun_glob_reg_upd3.1_log_res.stan'
#iteration samples
n_iter_warmup   = 50000
...
#output directory
dir_out = '../../Data/global_reg/bayesian_fit/JianFunUpd3.1_log_res/' + fname_out_main + '/'
...
# - - - - - - - - - - - 
#hyper-parameters
col_names_hyp = ['r1','s0','s1','s2','s3','sigma_vel']
